...
class PatientCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create patient_card" do
    assert_difference("PatientCard.count") do
      post patient_cards_url, params: { patient_card: { address: @patient_card.address, name: @patient_card.name } }
    end
  ...
  test "should update patient_card" do
    patch patient_card_url(@patient_card), params: { patient_card: { address: @patient_card.address, name: @patient_card.name } }
